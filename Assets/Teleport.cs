        ...
        switch (_currentUniverse)
        {
            case 0:
                if (controller.inVechile)
                {
                    ...
                    vehicleParent.transform.position = new Vector3(vehicleParent.transform.position.x, vehicleParent.transform.position.y, vehicleParent.transform.position.z - 1000);
                }
                else
                {
            ...
            case 1:
                ...
                if (controller.inVechile)
                {
                    ...
                    targetGameObject.transform.position = new Vector3(vehicleParent.transform.position.x, vehicleParent.transform.position.y, vehicleParent.transform.position.z + 1000);
                }
                else
                {
                    transform.position = new Vector3(transform.position.x, transform.position.y, transform.position.z + 200);
